...
function ItemList( {handleDetailDelete, setContextMenuIsVisible, userData, handleSubmit, setInputPopup, inputRef, inputPopup, userID, handleItemDelete, setUserData, sectionType, sectionItems, sectionDetails} ) {
